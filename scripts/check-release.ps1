...
$required = @(
    ...
    "src\DukkanPilot.Web\Controllers\DemoPacksController.cs",
    "src\DukkanPilot.Web\Helpers\DemoPackHelper.cs",
    "src\DukkanPilot.Web\Models\Demo\DemoPackViewModels.cs",
    "src\DukkanPilot.Web\Views\DemoPacks\Index.cshtml",
